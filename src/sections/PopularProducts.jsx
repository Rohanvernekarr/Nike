    ...
    <section id="products" className="max-container max-sm:mt-12">
      <div className="flex flex-col justify-start gap-5">
        <h2 className="text-4xl font-palanquin font-bold">Our{" "}
           <span className="text-coral-red inline-block transition-transform duration-300 hover:scale-105">{" "}Popular</span>{" "}products</h2>
           <p className="lg:max-w-lg mt-2 font-montserrat text-slate-gray">Experience Top notch quality and style with our sought after selections. 
            Discover a world of comfort, Design and values</p>
